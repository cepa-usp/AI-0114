package BaseAssets
{
	...
	public class BaseMain extends Sprite
	{
		...
		/**
		 * Atividade possui tutorial?
		 */
		private var hasTuto:Boolean = true;
		
		private var hasInfoBar:Boolean = true;
		
		protected var infoBar:InfoBar;
		
		protected var rect:Rectangle = new Rectangle(0, 0, 700, 500);
		...
		private function adicionaBotoes():void 
		{
			...
			if(hasTuto) botoes.addButton(new InfoBtn(), iniciaTutorial, "Reiniciar tutorial");
		...
		{
			layerAtividade.setChildIndex(child, index);
		}
